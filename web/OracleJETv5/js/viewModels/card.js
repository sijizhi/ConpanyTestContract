        ...
        $.ajax({
            ...
            success:function(data){
                $.each(data,function(index,item){
                     var a={Selected: ko.observable([]), CustomerId:item.customerId , CompanyName:item.companyName,Linkman :item.linkMan ,LinkmanPhone :item.linkManPhone ,CreateDate:item.createDate ,ModifyDate:item.modifyDate    };                     
                     deptArray.push(a); 
                })
            }
        });
    self.datasource = new oj.PagingTableDataSource(new oj.ArrayTableDataSource(deptArray, {idAttribute: 'CustomerId'}));
