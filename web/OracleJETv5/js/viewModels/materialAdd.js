...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'ojs/ojlabel',
     ...
     */
    function materialAddContentViewModel() {
        var self = this;
    }
         ...
         //  alert("baocun");
           ...
           if(materialName.length==0){
            ...
            $.ajax({
               async: false,
               type: "POST",
               url:"http://localhost:8081/contract/mat/addMat",
               contentType : "application/x-www-form-urlencoded;charset=UTF-8",
               data:{createUser:createUser,createDeptName:createDeptName,createDate:createDate,
                   materialName:materialName,importPrice:importPrice,inventory:inventory,remarks:remarks},
               dataType: "json",
               success: function (data) {
                   if(data.result=="true"){
                           alert("添加成功");
    ...
    return materialAddContentViewModel;
});
